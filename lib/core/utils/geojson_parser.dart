...
/// Converts the raw `geojson` object returned by Nominatim
/// (`polygon_geojson=1`) into [GeoZoneGeometry] usable by flutter_map's
/// `PolygonLayer`/`PolylineLayer`.
class GeoJsonParser {
  GeoJsonParser._();
  ...
  static GeoZoneGeometry? parse(Map<String, dynamic>? geojson) {
    ...
    switch (type) {
      ...
      default:
        // Point / MultiPoint / GeometryCollection: no shape to draw.
        return null;
    }
  }
